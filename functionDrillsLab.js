...
const campareNums = (num1, num2) => num1 > num2 ? num1 : num2
...
//CODE HERE
function frogPotter(gold) {
  return gold / 3
}

let totalFrogs = frogPotter(100)
...
let totalFrogs2 = frogPotter2(100)
